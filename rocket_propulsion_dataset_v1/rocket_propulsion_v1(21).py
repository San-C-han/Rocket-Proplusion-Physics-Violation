...
model = pickle.load(open(
    r"C:\Users\Priya\Desktop\ITV\ML Projects\rocket_propulsion_dataset_v1\physics_violation_model(21).sav",
    'rb'))

features = pickle.load(open(
    r"C:\Users\Priya\Desktop\ITV\ML Projects\rocket_propulsion_dataset_v1\model_features(21).sav",
    'rb'
))
